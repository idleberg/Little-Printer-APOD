<?php
	...
	if ($rss === false)  { 
	    print "Service currently unavailable, please try again later! If this problem persists, please report the issue at https://github.com/idleberg/Little-Printer-APOD/issues";
	    return;
	} else { 
